...
class Spaceship {
	...
	public int consumingFuel() { // 引数なし
		int lightYears = fuel / 2 * 10;
		fuel = fuel / 2;
		return lightYears;
	}

	public int consumingFuel(int consumingFuel) { // 引数あり
		int lightYears = consumingFuel * 10;
		fuel = fuel - consumingFuel;
		return lightYears;
	}
...
public class Astronaut {
	...
	public static void main(String[] args) throws IOException {
		...
		//ここに適切な処理を記述する。
		int resultAuto = spaceship.consumingFuel();
		System.out.println("航行距離：" + resultAuto + "光年\n");
		...
		//ここに適切な処理を記述する。
		int resultChoice = spaceship.consumingFuel(consumingFuel);
		System.out.println("航行距離：" + resultChoice + "光年\n");
